...
```mermaid
graph TD
    A[Partnership Ecosystem] --> B[Tier 1: Elite Ambassadors]
    A --> C[Tier 2: Technical Experts]
    A --> D[Tier 3: Lifestyle Performers]
    
    B --> B1[Professional Footballers / Runners]
    C --> C1[Sports Nutritionists / Coaches]
    D --> D1[Disciplined Professionals / Creators]
```
...
```mermaid
gantt
    title Influencer Program Rollout
    dateFormat  YYYY-MM-DD
    section Outreach
    Draft Target Influencer Pipeline   :active, 2026-06-01, 5d
    Initiate Outbound VIP DM/Email      : 2026-06-06, 5d
    section Activation
    Execute 14-Day Testing Phase        : 2026-06-11, 14d
    Launch Cohort 1 Partnership Content : 2026-06-25, 10d
```
